...
class ListView
{
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($totalpage<=1 && $this->TotalResult>0)
        {
            ...
            return "<li class=\"font\"><span class=\"pageinfo\">共 <strong>1</strong>页<strong>".$this->TotalResult."</strong>条记录</span></li>\r\n";
        }
        if($this->TotalResult == 0)
        {
            return "<li class=\"font\"><span class=\"pageinfo\">共 <strong>0</strong>页<strong>".$this->TotalResult."</strong>条记录</span></li>\r\n";
        }
        $purl = $this->GetCurUrl();
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<li class=\"last\"><a href='".str_replace("{page}",$prepagenum,$tnamerule)."'>上一页</a></li>\r\n";
        }
        else
        {
            $prepage.="<li class=\"last\"><a>上一页</a></li>\r\n";
        }
    ...
    function GetPageListDM($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($totalpage<=1 && $this->TotalResult>0)
        {
            return "<li class=\"font\"><span class=\"pageinfo\">共 1 页/".$this->TotalResult." 条记录</span></li>\r\n";
        }
        if($this->TotalResult == 0)
        {
            return "<li class=\"font\"><span class=\"pageinfo\">共 0 页/".$this->TotalResult." 条记录</span></li>\r\n";
        }
        $maininfo = "<li class=\"font\"><span class=\"pageinfo\">共 <strong>{$totalpage}</strong>页<strong>".$this->TotalResult."</strong>条</span></li>\r\n";
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<li class=\"last\"><a href='".$purl."PageNo=$prepagenum'>上一页</a></li>\r\n";
        }
        else
        {
            $indexpage="<li class=\"last\"><a>上一页</a></li>\r\n";
        ...
        {
            $endpage="<li class=\"next\"><a>下一页</a></li>\r\n";
